...
array_insert(
	...
	(
		'reports' => array
		(
			'tables' => array('tl_reports', 'tl_report_filter'),
			'icon'  => 'system/modules/reports/assets/report.png',
		)
	)
);

$GLOBALS['TL_HOOKS']['loadDataContainer'][] = array('Netzmacht\\Reports\\Config\\ReportsConfig', 'onLoadDataContainer');

$GLOBALS['TL_CSS'][] = 'system/modules/reports/assets/style.css';
